defmodule PurehavenWeb.AdminAuthTest do
  use PurehavenWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias Purehaven.Accounts
  alias PurehavenWeb.AdminAuth
  import Purehaven.AccountsFixtures
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, PurehavenWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_admin/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      PurehavenWeb.Endpoint.subscribe(live_socket_id)
